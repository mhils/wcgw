...
export default class PlayGame extends React.Component {
    ...
    render() {
        ...
        if ((!game || game.state === GameState.LOBBY)) {
            ...
            contents = <div>
                <p><i className="fa fa-spinner fa-pulse fa-4x"/></p>
            ...
            var progressbar = <div className="progress">
                <div className="progress-bar progress-bar-success" role="progressbar" style={progressbarStyle}></div>
            </div>;
